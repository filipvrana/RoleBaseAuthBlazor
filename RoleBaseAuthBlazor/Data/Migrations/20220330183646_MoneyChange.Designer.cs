...
namespace RoleBaseAuthBlazor.Data.Migrations
{
    ...
    [Migration("20220330183646_MoneyChange")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorUserMoneyy", b =>
                {
                    b.Property<string>("BlazorUsersId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("MoneyId")
                        .HasColumnType("int");

                    b.HasKey("BlazorUsersId", "MoneyId");

                    b.HasIndex("MoneyId");

                    b.ToTable("BlazorUserMoney", (string)null);
                });

            modelBuilder.Entity("BlazorUserPractice", b =>
                {
                    b.Property<string>("BlazorUsersId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("BlazorUsersId", "PracticesId");

                    b.HasIndex("PracticesId");

                    b.ToTable("BlazorUserPractice", (string)null);
                });
            ...
            modelBuilder.Entity("RoleBaseAuthBlazor.Data.Game", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorUserMoneyy", b =>
                {
                    b.HasOne("RoleBaseAuthBlazor.Data.BlazorUser", null)
                        .WithMany()
                        .HasForeignKey("BlazorUsersId")
            ...
            modelBuilder.Entity("BlazorUserPractice", b =>
                {
                    ...
                    b.HasOne("RoleBaseAuthBlazor.Data.Practice", null)
                        .WithMany()
